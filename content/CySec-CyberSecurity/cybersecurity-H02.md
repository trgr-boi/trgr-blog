...
- Nieuwe wet vanaf 15 februari 2023:
    - Beschrijft hoe een natuurlijke of rechtspersoon zonder frauduleuze bedoelingen kwetsbaarheden in netwerken en informatiesystemen kan opsporen en moet melden.
    - Het openbaar ministerie interpreteert de wetgeving nog steeds restrictief, wat betekent dat "hacking" nog steeds bij wet verboden blijft.
...
- **NIS 2 Directive**:
    - Biedt meer verduidelijking over hoe om te gaan met snelle technologische vernieuwingen.
    - Verplicht meer organisaties en sectoren om te werken rond cybersecurity.
    - Verplicht lidstaten om meer de wet te handhaven.
    - Ingevoerd op 16 januari 2023 en moet tegen 17 oktober 2024 in de nationale wetgevingen van EU-lidstaten staan.

---

### NIST Framework

- Het **National Institute of Standards and Technologies (NIST)** framework biedt bedrijven een raamwerk voor cybersecurity.
    - Het stelt bedrijven in staat om de belangrijkste verantwoordelijkheden, functietitels en benodigde personeelsvaardigheden te identificeren.

---

### Het ISO/IEC Cybersecurity Model

- Het **ISO/IEC cybersecurity model** is een hulpmiddel om complexe cybersecurityproblemen aan te pakken.
    - Het ISO 27000 model is een standaard die als richtlijn dient voor cybersecurity en wordt wereldwijd door veel landen en organisaties toegepast.
    - De organisatie bepaalt zelf welke controle doelstellingen voor hen van toepassing zijn.
...
- **Privacy als fundamenteel recht**: Iedereen heeft recht op privacy, inclusief encryptie van privé-informatie en gesprekken.
- **Security boven privacy**: Beveiliging is belangrijker, omdat terroristen en criminelen encryptie gebruiken om zich te beschermen, wat het moeilijker maakt voor de politie om hen op te sporen.

Politici pleiten vaak voor **achterpoortjes** (backdoors) in encryptiesoftware, zodat politie geëncrypteerde berichten kan lezen. Dit kan echter misbruikt worden door zowel overheden als cybercriminelen. Encryptie zonder achterpoortjes wordt al gebruikt door criminelen. Technologiebedrijven verzetten zich vaak tegen backdoors, aangezien de politici onvoldoende kennis hebben over de gevolgen ervan.

---

### Het eeuwige conflict

- **Politie** strijdt tegen criminaliteit (terrorisme, kinderporno, fraude, enz.)
- **Burgers** hebben recht op privacy (briefgeheim, persoonlijke data).

---

### Overheid en data

- **Data verzamelen**: De overheid verzamelt gegevens voor verschillende doeleinden (belasting, boetes, enz.).
- **Hoe ver mag de overheid gaan?** Wat als de data verkeerd wordt gebruikt of als er fouten in de data zitten?

---

### "Ik heb niets te verbergen"

Veel mensen denken dat privacy minder belangrijk is als ze geen “geheimen” hebben. Echter, persoonlijke gegevens zoals seksuele voorkeur, medische informatie, en financiële problemen moeten beschermd blijven.

---

### Big Brother

Er is een groeiende bezorgdheid over **overheidscontrole** via sociale media en andere platforms, waarbij persoonlijke informatie kan worden gebruikt voor toezicht en controle.

---

### GDPR (AVG)

- **Doelen van de GDPR**: Bescherming van privacy in de EU.
- **Rechten**:
    - **Inzage** in gegevens
...
- Gegevens moeten voor een **correct doel** worden verzameld.
- Alleen **noodzakelijke gegevens** mogen worden opgevraagd.
- Gegevens mogen alleen voor een **beperkte duur** worden bewaard.
- **Toestemming** van de gebruiker is vereist.

### Toestemming

- Moet expliciet zijn (niet automatisch aangevinkt).
...
De **Gegevensbeschermingsautoriteit** controleert de naleving van de GDPR en kan helpen als rechten geschonden worden.

---

### Handige links

- Privacygidsen en tools om je privacy te beschermen.
...
### Belang van privacy in de cursus

- De cursus richt zich op cybersecurity, maar **privacy is even belangrijk**.
- De balans tussen **privacy en cybersecurity** moet altijd worden afgewogen.